...
bool midi_init(void)
{
	...
	//fluid_settings_getstr_default(settings, "synth.default-soundfont", defaultSF);
	fluid_settings_getstr_default(settings, "synth.default-soundfont", &defstr);
	//Warning("Default SF = %s\n", defstr);


	//fluid_synth_sfload(synth, "/usr/share/sounds/sf2/default-GM.sf2", 1);;
